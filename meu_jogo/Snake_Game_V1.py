...
class Snake_Game:
    def __init__(self):
        ...
        self.natal_bg = pg.image.load('pixil-frame-0.png').convert()
        self.natal_bg = pg.transform.scale(self.natal_bg, (1000, 760))
        # Game Colors
        self.color = {
            'black': (  0,   0,   0),
            'gray':  (150, 150, 150),
    ...
    def game_start_countdown(self, window):
        ...
        pg.draw.circle(window, self.color['white'], (500, 360), 50)

        # Draw center text
        if self.countdown == 3:
            countdown_text = self.font.render('3', True, self.color['black'])
            window.blit(countdown_text, (484, 335))
            self.countdown -= 1
            ...
            window.blit(countdown_text, (462, 335))
            self.countdown -= 1
    ...
    def draw_map_elements(self, window):
        ...
        for y in range(self.map_size[1]):
            for x in range(self.map_size[0]):
                ...
                if self.map[y][x] == 'a':
                    pg.draw.rect(window, self.color['black'], (x * side , y * side, side, side))
    ...
    def draw_end_game(self, window):
        ...
        if self.end_game == True:
            ...
            window.blit(score_text, (410, 336))
...
w = Window(screen_resolution=(1000, 720))
...
while True:
    ...
    natal_bg = pg.image.load('pixil-frame-0.png')
    w.window.blit(natal_bg, (0, 0))
